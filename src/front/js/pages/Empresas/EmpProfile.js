    ...
    return (
        <div>
            ...
            <form>
                ...
                <div className="mb-3">
                    <label for="nombre" className="form-label">Nombre de la empresa</label>
                    <input type="text" className="form-control" id="nombre" />
                </div>

                <div className="mb-3">
                    <label for="ntrabajadores" className="form-label">Numero de trabajadores</label>
                    <input type="text" className="form-control" id="ntrabajadores" />
                </div>

                <div className="mb-3">
                    <label for="Ubicacion" className="form-label">Ubicacion</label>
                    <input type="text" className="form-control" id="Ubicacion" />
                </div>

                <div className="mb-3">
                    <label for="tipoempleo" className="form-label">Tipo de empleo</label>
                    <input type="text" className="form-control" id="tipoempleo" />
                </div>

                <div className="mb-3">
                    <label for="Sede" className="form-label">Sede</label>
                ...
                <div className="mb-3">
                    <label for="Sector" className="form-label">Sector</label>
                    <input type="text" className="form-control" id="Sector" />
                </div>

                <div className="mb-3">
                    <label for="idf" className="form-label">Identificacion fiscal (C.I.F o N.I.F)</label>
